...
class DetailsTicketUser extends StatelessWidget {
  DetailsTicketUser({Key? key, }) : super(key: key);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildLabelValuePair('اسم الامتحان', 'name!'),
                    const Divider(
                      thickness: 2,
                      color: OtrojaColors.primaryColor,
                    ),
                    kVerticalSpacing,
                    _buildSubLabelValuePair('تاريخ الامتحان', '12'),
                    kVerticalSpacing,

                    _buildSubLabelValuePair(
                        'الامتحان يبدأ في غضون', '222'),
                    kVerticalSpacing,
                    _buildSubLabelValuePair(
                        'مدة الامتحان', '{showExamsModel.} دقيقة '),
                  ],
                ),
              ),
            ),
